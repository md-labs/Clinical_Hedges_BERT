...
class InputProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, i, task_num):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Train_Data_Part_{}_Task_{}.tsv".format(i, task_num))), "train")

    def get_dev_examples(self, data_dir, i, task_num):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Dev_Data_Part_{}_Task_{}.tsv".format(i, task_num))), "dev")

    def get_test_examples(self, data_dir, i, task_num):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Test_Data_Part_{}_Task_{}.tsv".format(i, task_num))), "test")
